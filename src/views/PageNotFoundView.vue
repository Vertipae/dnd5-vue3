<template>
  <h1 class="pageNotFound">Page Not Found 404</h1>
...
https://codepen.io/alexsafayan/pen/PogERe
-->
  ...
  <h3 class="randomText">{{ randomText() }}</h3>
</template>
  ...
  setup() {
    const randomText = () => {
      const randomQuote = [
        ...
        '"Is not the dragon the hero of his own story?" -Erin Morgenstern.',
        ...
        '"Dragon guarded the treasure. Glittering gold and silver. Smell of sulphur and fire. In the dragon\'s lair. Hidden in his mountain. Upon the bones of those who failed." -Morgana Lefay.',
      ];
...
.particles {
  ...
  font-family: 'HelveticaNeue-UltraLight', 'Open Sans',
    'Helvetica Neue UltraLight', Roboto, Arial, Sans-serif;
  color: #151b1f;
  text-align: center;
